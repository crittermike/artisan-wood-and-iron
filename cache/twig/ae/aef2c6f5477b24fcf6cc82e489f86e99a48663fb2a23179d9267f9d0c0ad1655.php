...
class __TwigTemplate_3193133466c43e2326017a36ead7be59aa3b46abef0b3b32871a0eec507817f3 extends Twig_Template
{
     ...
     ";
        ...
        if ($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "vimeo", array())) {
         ...
         <div class=\"embed-vimeo\" style=\"text-align:center;\"><iframe src=\"";
            // line 5
            echo $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "vimeo", array()), "src", array());
            echo "\" width=\"";
            echo $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "vimeo", array()), "width", array());
            echo "\" height=\"";
            echo $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "vimeo", array()), "height", array());
...
", "modular/default.html.twig", "/Users/mcrittenden/Dropbox/Code/artisan-wood-and-iron/user/themes/gateway/templates/modular/default.html.twig");
    }
}
